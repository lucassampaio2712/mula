...
/* ===== Login Modal: Auto-open and interaction ===== */
(function() {
    ...
    function openModal() {
        ...
        loginModalOverlay.classList.add('is-open');
    }

    // Close modal
    function closeModal() {
        loginModal.classList.remove('is-open');
        loginModalOverlay.classList.remove('is-open');
    }
    ...
    if (loginBtn) {
        loginBtn.addEventListener('click', (e) => {
            ...
            // Replace [name] and [email] placeholders with actual values
            let whatsappUrl = loginBtn.getAttribute('href');
            whatsappUrl = whatsappUrl.replace('[name]', encodeURIComponent(nome));
            whatsappUrl = whatsappUrl.replace('[email]', encodeURIComponent(email));
